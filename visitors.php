...
$password=$_REQUEST['password'];
 $_SESSION['un']=$name;
 $qry="select * from visitor_details where email='$name' && password='$password'";
...
<div class="tittle_head_w3ls">
				<h3 align="center" class="tittle three">Visitors Login</h3>
  </div>
 <form name="form1" method="post" action="">
   <table height="127" align="center">
     ...
     <tr>
       <td>&nbsp;</td>
       <td><p><a href="visitors_register.php"> Don't have an account?</a></p>
          </td>
     </tr>
   </table>
 </form>
