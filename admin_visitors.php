...
<div class="tittle_head_w3ls">
				<h3 align="center" class="tittle three">&nbsp;</h3>
				<h3 align="center" class="tittle three">Visitors Request Details </h3>
</div>
 <form name="form1" method="post" action="">
   <table width="50%" height="78"  align="center">
     ...
     <?php
	 $qrys1="select * from  user_request where status=0";
     ...
     <tr>
       ...
       <td><a href="admin_visitors_accept.php?id=<?php echo $row['id'];?>">Accept</a></td>
     </tr>
     <?php
	 }
	 ?>
