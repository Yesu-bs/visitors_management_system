          ...
          <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
					 ...
					 <li class="nav-item @@about__active ">
                          <a class="nav-link" href="admin_visitors.php">Visitors</a>
                      </li>
...
<div class="tittle_head_w3ls">
				<h3 align="center" class="tittle three">Search</h3>
  </div>
 <form name="form1" method="post" action="">
   <table height="127" align="center">
      <tr>
        <td>From</td>
        <td> 
          <input name="a" type="date" id="a" required="">
        </td>
      </tr>
      <tr>
        <td>To</td>
        <td><input name="b" type="date" id="b" required=""></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><label>
   ...
   <table width="50%" height="78"  align="center">
     ...
     <?php
	 $qrys1="select * from  user_request where date>='$a' and date<='$b'";
     ...
     <tr>
	   ...
	   {
	   ?>
           <a href="visitor_pass_1.php?id=<?php echo $row['id'];?>">View</a>
           <?php
	   }
