...
$password=$_REQUEST['password'];
 ...
 $sql = "SELECT id FROM visitor_details order by id ASC";
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into visitor_details values($sid,'$name','$contact','$email','$address','$username','$password','0','0')";
...
<div class="tittle_head_w3ls">
				<h3 align="center" class="tittle three">Visitors Registration </h3>
  </div>
